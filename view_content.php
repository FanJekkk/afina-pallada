...
<ul id="block-tur">
<?php
$result2 = mysql_query("SELECT * FROM directory where id_direct='$id1'",$link);
 if (mysql_num_rows($result2) > 0)
 {
    $row2 = mysql_fetch_array($result2);
    do
    {
         if ($row2["id_type"]='1' and ($_SESSION['auth'] == 'yes_auth'))
        echo '
        <div id="block_content_info">
        <p id="navi"><a href=ecscurs.php>Экскурсии</a> \ <span>'.$row2["title"].'</span></p>
        </div>
        <div id="block-info">
        ...
        <center><br><a class="add-cart-style-grid" tid="'.$row2["id_direct"].'">Заказать</a></br></center>
        ';
        else
        echo '
        <div id="block_content_info">
        ...
        <center><br><p id="error">Чтобы заказать экскурсию, необходимо зарегистрироваться и/или авторизироваться</p></br></center>
        ';
        }
